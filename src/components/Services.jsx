...
const CustomModal = memo(({ isOpen, onClose, title, description, children }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center py-10 bg-black bg-opacity-70 backdrop-blur-sm animate-fadeIn">
      <div
        ref={modalRef}
        className="w-full max-w-md bg-white rounded-xl shadow-2xl transform transition-all duration-300 animate-scaleIn"
        role="dialog"
        aria-modal="true"
      >
        <div className="p-6">
  ...
  return (
    <div className="overflow-hidden group hover:shadow-2xl transition-all duration-300 border border-slate-200 rounded-xl bg-white transform hover:-translate-y-1">
      <div className="relative h-56 overflow-hidden">
        <div
          className={`absolute inset-0 bg-blue-100 ${isImageLoaded ? "opacity-0" : "opacity-100"} transition-opacity duration-300`}
        ></div>
        <img
        ...
        <div className="absolute top-4 right-4">
          <span className="px-3 py-1 text-xs font-medium rounded-full bg-white text-blue-500 shadow-md">
            {service.category}
          </span>
        </div>
      ...
      <div className="p-5 pb-2 flex flex-row items-center">
        <div className="mr-3 p-3 rounded-full bg-blue-50 text-blue-500 shadow-sm">{service.icon}</div>
      ...
      <div className="p-5 pt-2">
        ...
        <div className="flex justify-between items-center">
          ...
          <a
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-blue-500 rounded-md hover:bg-blue-600 transition-colors shadow-md hover:shadow-lg"
          >
            Get Quote
          </a>
        </div>
        ...
        >
          <div className="mt-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="block w-full px-4 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded-md hover:bg-blue-600 transition-colors shadow-md"
            >
              Get a Quote
            </a>
          </div>
...
const ServicesPage = () => {
  ...
  return (
    <div className="w-full px-4 py-16 space-y-12">
      {/* Hero Section */}
      <section className="relative mb-24 rounded-3xl overflow-hidden bg-white shadow-xl animate-slideInUp w-full">
        ...
        <div className="relative z-10 py-20 px-6 md:px-12 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-md text-white bg-blue-500 hover:bg-blue-600 transition-all duration-300 shadow-lg hover:shadow-blue-500/30 transform hover:-translate-y-1"
            >
              Request a Quote <ArrowRight className="ml-2 h-4 w-4" />
            </a>
            <a
              href="tel:+919146924531"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-md text-white border border-white hover:bg-white hover:text-gray-900 transition-all duration-300 shadow-lg hover:shadow-white/30 transform hover:-translate-y-1"
            >
      ...
      <section
        className="mb-24 bg-white p-8 rounded-xl shadow-xl animate-slideInUp w-full"
      ...
      >
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-3">Manufacturing Facility</h2>
      ...
      <section
        className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-2xl p-8 md:p-12 shadow-2xl animate-slideInUp w-full"
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-md text-blue-900 bg-white hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-white/30 transform hover:-translate-y-1"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-5 py-3 text-base font-medium rounded-md text-white border border-white hover:bg-white hover:text-blue-900 transition-all duration-300 shadow-lg hover:shadow-white/30 transform hover:-translate-y-1"
            >
              WhatsApp Us
            </a>
          </div>
